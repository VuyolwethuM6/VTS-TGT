      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.statsGrid}>
          <View style={styles.statsCard}>
            ...
            <Text style={styles.statsTitle}>My Invites</Text>
          ...
          <View style={styles.statsCard}>
            ...
            <Text style={styles.statsTitle}>Presentations</Text>
            <View style={styles.statsIcon}>
              <Ionicons name="easel-outline" size={24} color="#FFD700" />
            </View>
          </View>

          <View style={styles.statsCard}>
            <Text style={styles.statsValue}>3</Text>
            <Text style={styles.statsTitle}>My Recruits</Text>
            <View style={styles.statsIcon}>
